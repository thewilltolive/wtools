...
#ifdef DEBUG_ASSERT
  Assert(!tree->nil->red,(char *)"nil not red in LeftRotate");
#endif
}
...
#ifdef DEBUG_ASSERT
  Assert(!tree->nil->red,(char *)"nil not red in RightRotate");
#endif
}
...
#ifdef DEBUG_ASSERT
  Assert(!tree->nil->red,(char *)"nil not red in TreeInsertHelp");
#endif
}
...
#ifdef DEBUG_ASSERT
  Assert(!tree->nil->red,(char *)"nil not red in RBTreeInsert");
  Assert(!tree->root->red,(char *)"root not red in RBTreeInsert");
#endif
}
...
#ifdef DEBUG_ASSERT
  Assert(!tree->nil->red,(char *)"nil not black in RBDeleteFixUp");
#endif
}
...
#ifdef DEBUG_ASSERT
    Assert( (y!=tree->nil),(char *)"y is nil in RBDelete\n");
#endif
...
#ifdef DEBUG_ASSERT
  Assert(!tree->nil->red,(char *)"nil not black in RBDelete");
#endif
}
