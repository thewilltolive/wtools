...
struct bkv_to_json_parser_s{
    ...
    bkv_error_t (*to_json_boolean_fn)(bkv_to_json_ctx_t *l_ctx, uint8_t *str, int strlen, bool v);
    bkv_error_t (*to_json_array_float_fn)(bkv_to_json_ctx_t *l_ctx, float f);
    bkv_error_t (*to_json_array_boolean_fn)(bkv_to_json_ctx_t *l_ctx, bool f);
